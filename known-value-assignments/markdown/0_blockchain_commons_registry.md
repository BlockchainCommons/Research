...
| 21        | `validFrom`      | property | https://schema.org/validFrom                          | The subject is valid from the date in the object.                                                |
...
| 25        | `value`          |          |                                                       | The object is the primary value in a set of assertions. Frequently used with `salt`.             |
| 26        | `attestation`    | property |                                                       | Natural language assertion statement                                                             |
| 27        | `verifiableAt`   | property |                                                       | URI where attestation can be verified                                                            |
