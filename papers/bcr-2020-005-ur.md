...
fragments = StringPartition[bytewordsPayload, UpTo[maximumFragmentCharacters]];
```
...
```
parts = AddHeadersToFragments[fragments, type, bytewordsDigest];
```
...
:= payload // ToHex // Short
c5d455c6a75135897bfedfab6b32066be155966440024b778f3f...1156fb999633184b6d4ab71cf95982bf7bfe28c74d327111752bf
```
...
590320c5d455c6a75135897bfedfab6b32066be155966440024b...1156fb999633184b6d4ab71cf95982bf7bfe28c74d327111752bf
```
...
hkaxcxsktygoswosgyecldkgzmurpyjeeyamjevygomtiefzaogr...liaehlrrptypyjstkmdmkdnylrsvolkjytedibychgmrsjyrnaaay
```

* Compute the SHA256 digest of the CBOR-encoded payload

```
:= digest = BytewordsHash[cborPayload];
:= digest // ToHex
34909440465a380f3f9eca4949f4f62fc8667ccde7d3f4cafb58673ea5abe926
```
...
:= bytewordsDigest = BytewordsEncode[digest];
:= bytewordsDigest
eemhmwfzfghtetbsfhnnsggagawkyndlspiykesnvdtewksgzthdiofmonpywldstivlwffn
```
...
:= fragments = StringPartition[bytewordsPayload, UpTo[maximumFragmentCharacters]];
:= First[fragments]

```

* Prepend each fragment with a header that includes scheme, type, sequencing, and digest

```
:= parts = AddHeadersToFragments[fragments, "bytes", bytewordsDigest];
:= First[parts]
ur:
```
