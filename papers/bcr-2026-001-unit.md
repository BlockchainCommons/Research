...
> **Note:** The example above assumes you are using `envelope` CLI version 0.31.2 or later, and that you have installed the [JSON FOAF ontology](https://github.com/BlockchainCommons/Research/tree/master/known-value-assignments/json) in your local known values store in `~/.known-values/`.
